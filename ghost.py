...
:   :          ` . `.          {0}[{1}4{0}] {2}Access shell on a phone
 `.. :            `. ``;       {0}[{1}5{0}] {2}Install an apk on a phone
    `:;             `:'        {0}[{1}6{0}] {2}Screen record a phone
       :              `.       {0}[{1}7{0}] {2}Get phone screenshot
        `.              `.     {0}[{1}8{0}] {2}Restart ADB Server
          `'`'`'`---..,___`.   {0}[{1}9{0}] {2}Pull folders from phone        
                     
{0}[{1}10{0}] {2}Shutdown the phone        {0}[{1}19{0}]{2} Extract apk from app                         
{0}[{1}11{0}] {2}Uninstall an app          {0}[{1}20{0}]{2} Get Battery Status
{0}[{1}12{0}] {2}Show log of device        {0}[{1}21{0}]{2} Network status
{0}[{1}13{0}] {2}Dump System Info          {0}[{1}22{0}]{2} Turn WiFi on/off
{0}[{1}14{0}] {2}List all phone apps       {0}[{1}23{0}]{2} Remove Password
{0}[{1}15{0}] {2}Run a phone app           {0}[{1}24{0}]{2} Use Ghost Keycode
